...
public:
    ...
    static void DrawSquidRoom(GfxContext& context, bool bindTextures, uint32_t rootIndex = UINT32_MAX, uint32_t diffuseOffset = UINT32_MAX, uint32_t normalOffset = UINT32_MAX);
