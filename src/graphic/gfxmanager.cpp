...
void GfxManager::Initialize(tf::Taskflow& tf)
{
    ...
    tf::Task frameParamsCBInitTask  = tf.emplace([&]() { m_FrameParamsCB->Initialize(m_GfxDevice->GenerateNewContext(D3D12_COMMAND_LIST_TYPE_DIRECT, "FrameParams"), sizeof(AutoGenerated::FrameParams), "FrameParams GfxConstantBuffer"); });
