...
void GfxManager::Initialize(tf::Subflow& subFlow)
{
    ...
    tf::Task generalGfxInitTask = subFlow.emplace([&](tf::Subflow& subFlow)
        {
            ...
            InplaceArray<tf::Task, 16> allTasks;

            allTasks.push_back(ADD_SF_TASK(subFlow, g_GfxDefaultTextures.Initialize(sf)));
    ...
    adapterAndDeviceInit.precede(cmdListInitTask, rootSigManagerInitTask, PSOManagerInitTask, generalGfxInitTask, swapChainInitTask);
