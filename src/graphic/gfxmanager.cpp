    ...
    tf::Task generalGfxInitTask = tf.emplace([&]()
        {
            ...
            tf::Task gfxDefaultTexturesInitTask = tf.emplace([&]() { g_GfxDefaultTextures.Initialize(); });
            tf::Task frameParamsCBInitTask = tf.emplace([&]() { m_FrameParamsCB.Initialize<AutoGenerated::FrameParams>(); });
