...
void GfxShaderManager::Initialize(tf::Subflow& sf)
{
    ...
    sf.parallel_for(AutoGenerated::gs_AllShadersData, AutoGenerated::gs_AllShadersData + _countof(AutoGenerated::gs_AllShadersData), [&](const AutoGenerated::AutoGeneratedShaderData& data)
        {
