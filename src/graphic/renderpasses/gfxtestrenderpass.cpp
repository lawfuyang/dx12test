...
void GfxTestRenderPass::Initialize()
{
    ...
    GfxContext& initContext = g_GfxManager.GetGfxDevice().GenerateNewContext(D3D12_COMMAND_LIST_TYPE_DIRECT, "GfxTestRenderPass Init");

    m_QuadVBuffer.Initialize(vList, _countof(vList), sizeof(Vertex), "GfxTestRenderPass GfxVertexBuffer");
    m_QuadIBuffer.Initialize(iList, _countof(iList), sizeof(uint16_t), "GfxTestRenderPass GfxIndexBuffer");
