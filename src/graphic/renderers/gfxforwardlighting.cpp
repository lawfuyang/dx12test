...
void GfxForwardLightingPass::Initialize()
{
    ...
    m_RootSigHash = g_GfxRootSignatureManager.GetOrCreateRootSig(ranges, D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT, "GfxForwardLightingPass_RootSignature");
...
void GfxForwardLightingPass::PopulateCommandList(GfxContext& context)
{
    ...
    context.SetShader(g_GfxShaderManager.GetShader(Shaders::PS_ForwardLighting{}));
    ...
    for (Visual* visual : g_Scene.m_AllVisuals)
    {
        ...
        vsPerms.Permutations.VERTEX_FORMAT_Position3f_Normal3f_Texcoord2f = vFormat == GfxDefaultVertexFormats::Position3f_Normal3f_Texcoord2f;
        vsPerms.Permutations.VERTEX_FORMAT_Position3f_Normal3f_Texcoord2f_Tangent3f = vFormat == GfxDefaultVertexFormats::Position3f_Normal3f_Texcoord2f_Tangent3f;
        ...
        instanceConsts.m_UseGlobalPBRConsts = visual->m_UseGlobalPBRConsts;
