...
void GfxBodyGravityParticlesUpdate::Initialize()
{
    ...
    BodyGravityParticles::gs_ParticlesUAV.Initialize(CD3DX12_RESOURCE_DESC1::Buffer(BodyGravityParticles::gs_ParticleCount * sizeof(AutoGenerated::BodyGravityPosVelo), D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS));
