...
static void StaticStringUnitTest_Construction()
{
    ...
    {
        StaticString<64> stringTest2("The quick brown fox jumps over the lazy dog");
        assert(stringTest2 == "The quick brown fox jumps over the lazy dog");
        assert(stringTest2.empty() == false);
        assert(stringTest2.capacity() >= 64);
        assert(stringTest2.length() == 43);
    }
