...
static void PrintShaderInputCPPFile(const ShaderInputs& inputs)
{
    ...
    for (const ShaderInputs::Structure& globalStruct : inputs.m_GlobalStructures)
    {
        generatedString += StringFormat("struct %s {\n", globalStruct.m_Name.c_str());
        for (const ShaderInputs::Constant& var : globalStruct.m_Constants)
        {
